...
static bool terrain_compile_shaders(void) {
    ...
    NSString *src = @
        ...
        "    TerrainOut out;\n"
        "    // DEBUG: override position to fill entire screen as a test\n"
        "    // Maps vertex index to fullscreen triangle\n"
        "    float2 debugPos[3] = {float2(-1,-1), float2(3,-1), float2(-1,3)};\n"
        "    out.position = float4(debugPos[vid % 3], 0.5, 1.0);\n"
